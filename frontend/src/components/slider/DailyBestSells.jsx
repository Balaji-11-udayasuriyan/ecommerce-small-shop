        ...
        <div className="row">
          ...
          <div className="col-lg-9 col-md-12 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
            <div className="tab-content" id="myTabContent-1">
                    ...
                    <div className="row"></div>
                        ...
                        <div className="product-cart-wrap">
                            ...
                            <div className="product-img product-img-zoom">
                                ...
                                <img className="default-img" src="frontend/imgs/shop/product-1-1.jpg" alt="" />
                                <img className="hover-img" src="frontend/imgs/shop/product-1-2.jpg" alt="" />
                                </a>
                            </div>
                            <div className="product-action-1">
                                ...
                                <a aria-label="Compare" className="action-btn small hover-up" href="shop-compare.html">
              ...
              {/* Tab Panes for Popular and New Added Products */}
