...
const Contact = () => {
    ...
    useEffect(() => {
        ...
        if (!mapContainer._leaflet_id) {
            const latitude = 11.750880104366276; // Replace with your latitude
            const longitude = 79.74914099789473; // Replace with your longitude

            const map = L.map("map-panes").setView([latitude, longitude], 13);
        ...
        <div class="page-content pt-50">
            ...
            <section class="container mb-50 d-none d-md-block">
                <div class="border-radius-15 overflow-hidden">
                    <div id="map-panes" style={{ height: "400px", width: "100%" }}></div>
                </div>
            </section>
            <div class="container">
                <div class="row">
